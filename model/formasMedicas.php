...
<div class="container-fluid mb-4 mt-4">
    <div class="row">
        ...
        <div class="col">
            ...
            <h2>Formas Medicas Registradas</h2>
            </div>
            ...
            data-bs-toggle='modal' data-bs-target='#exampleModalAgregarFormaMedicina' data-bs-whatever='@mdo'>Agregar Formas Medicas</button>
            </div>
            <div class='modal fade' id='exampleModalAgregarFormaMedicina' tabindex='-1' aria-labelledby='exampleModalLabel' aria-hidden='true'>
                <div class='modal-dialog '>
                    <div class='modal-content'>
                        <div class='modal-header'>
                            <h1 class='modal-title fs-5' id='exampleModalLabel'>Agregar Forma Medica</h1>
                            <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close'></button>
                        </div>
                        <div class='modal-body d-flex align-item-center justify-content-center'>
                        
                
                            <form action='./controller/CtrlUsuario.php' method='post' enctype='multipart/form-data' onsubmit='return ValidacionRegistroFormas();'> 
    
                                <div class='mb-3'>
                                    <label class='col-form-label' for='formamed'>Forma Medica Registrada</label>
                                    <input type='text' class='form-control' id='formamed'  name='formamed'>
                                </div>
